if($.cookie("color")) {
    $("link[href|='Content/css/color']").attr("href", "Content/css/" + $.cookie("color"));
}
...
$(document).ready(function() { 
    $("#color-switcher-content .color").click(function () {
        console.log($("link[href|='Content/css/color']"));
        $("link[href|='Content/css/color']").attr("href", "~/Content/css/" + $(this).attr('rel'));
